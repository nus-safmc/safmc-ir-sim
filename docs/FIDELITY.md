...
| F-3 | Unreliable ToF returns are substituted with a hard-coded 0.40 m "assume obstacle" | Modelled explicitly, off by default | The real conservative substitution changes VFH behaviour near glass and dark surfaces |
